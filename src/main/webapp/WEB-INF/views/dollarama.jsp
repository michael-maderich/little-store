...
<jsp:include page="headElement.jsp">
	<jsp:param name="title" value="The Little Store - $1 And Under Items" />
	<jsp:param name="page" value="dollarama" />
</jsp:include>
	</head>
	<body>
		<header>
	...
	<jsp:param name="subCatName" value="${subCategoryName}" />
 			...
 			<div id="center-content">
				<div id="product-panel">
					<h2>Items For $1 or Less</h2>
					${empty itemList ? '<div class="itemsHeader"><br><h4>No $1 Items :(</h4></div>' : ''}
