...
<jsp:include page="headElement.jsp">
	<jsp:param name="title" value="The Little Store - Search Results" />
	<jsp:param name="page" value="searchresults" />
</jsp:include>
	</head>
	<body>
		<header>
	...
	<jsp:param name="categoryName" value="${categoryName}" />
 			...
 			<div id="center-content">
				<div id="product-panel">
					...
					<div class="itemsHeader"><br/><h4>${empty itemList ? '\"'.concat(searchText).concat('\"').concat('<br/><br/>No Results Found!') : '\"'.concat(searchText).concat('\"').concat('<br/><br/>').concat(searchItemQty).concat(' Results:')}</h4></div>
